...
public class IntList {
    ...
    public static IntList catenate(IntList A, IntList B) {
        if (A == null) {
            if (B != null) {
                ...
                IntList head = result;
                while (B.rest != null) {
                    head.rest = new IntList(B.rest.first, null);
                    head = head.rest;
                    B = B.rest;
                }
                return result;
            ...
            IntList head = result;
            while (A.rest != null) {
                head.rest = new IntList(A.rest.first, null);
                head = head.rest;
                A = A.rest;
            }
            if (B != null) {
    ...
    public static IntList reverse(IntList head) {
        if (head == null || head.rest == null) {
            ...
            IntList endOfReverse = head.rest;
            IntList reversed = reverse(head.rest);
            endOfReverse.rest = head;
            head.rest = null;
            return reversed;
        }
    }
